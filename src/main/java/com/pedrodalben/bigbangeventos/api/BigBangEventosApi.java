...
public final class BigBangEventosApi {
    ...
    public CombatProviderRegistry combatProviders(){return engine.combatProviders();}
    public CombatAttributionService combatAttribution(){return engine.combatAttribution();}
    public CombatActorEligibilityService combatEligibility(){return engine.combatEligibility();}
}
